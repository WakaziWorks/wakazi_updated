    ...
    try {
        ...
        if ($result->num_rows > 0) {
            ...
            if (password_verify($password, $user['password'])) {
                ...
                updateCartDetails($mysqli, $user['customer_id'], $phoneNumber);  // Update cart details with user id
            ...
            if ($_POST['password'] === $_POST['confirmPassword']) {
                ...
                updateCartDetails($mysqli, $user_id, $phoneNumber);  // Insert cart details for new user
