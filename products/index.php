        ...
        <div class="row">
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                <div class="col-md-4 mb-3">
                    <div class="card">
                    <img src="placeholder.jpg" height="170px" width="25%" data-src="<?php echo 'data:image/jpeg;base64,' . base64_encode($row['image']); ?>" class="lazyload card-img-top" alt="Product Image">
                        <div class="card-body">
